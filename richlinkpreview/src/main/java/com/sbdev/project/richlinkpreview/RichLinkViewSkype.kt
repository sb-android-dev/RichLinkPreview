...
import com.sbdev.project.richlinkpreview.databinding.SkypeLinkLayoutBinding
import com.squareup.picasso.Picasso

class RichLinkViewSkype(
    context: Context,
    ...
    fun initView(){
        val binding = SkypeLinkLayoutBinding.inflate(LayoutInflater.from(context))
        ...
        if(meta.favicon.isBlank()) {
            binding.richLinkFavicon.visibility = GONE
        } else {
            binding.richLinkFavicon.visibility = VISIBLE
            Picasso.get()
                .load(meta.favicon)
                .into(binding.richLinkFavicon)
        }
