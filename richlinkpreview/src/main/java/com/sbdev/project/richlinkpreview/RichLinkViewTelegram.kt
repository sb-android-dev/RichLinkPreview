...
import com.sbdev.project.richlinkpreview.databinding.TelegramLinkLayoutBinding
import com.squareup.picasso.Picasso


class RichLinkViewTelegram(
    context: Context,
    ...
    fun initView(){
        val binding = TelegramLinkLayoutBinding.inflate(LayoutInflater.from(context))
        ...
        binding.richLinkOriginalUrl.text = mainUrl
        removeUnderlines(binding.richLinkOriginalUrl.text as Spannable)
    ...
    private fun removeUnderlines(p_Text: Spannable) {
        ...
        for (span in spans) {
            ...
            val span1 = URLSpanNoUnderline(span.url)
            p_Text.setSpan(span1, start, end, 0)
        }
    }
}