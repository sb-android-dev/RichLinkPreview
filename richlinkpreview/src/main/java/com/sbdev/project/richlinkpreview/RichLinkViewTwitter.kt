...
import com.sbdev.project.richlinkpreview.databinding.TwitterLinkLayoutBinding
import com.squareup.picasso.Picasso

class RichLinkViewTwitter(
    context: Context,
    ...
    fun initView(){
        val binding = TwitterLinkLayoutBinding.inflate(LayoutInflater.from(context))
